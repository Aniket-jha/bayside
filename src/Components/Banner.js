...
import BaysideMainImage from "../asset/BaysideOne.webp"
import BaysideOneImage from "../asset/canteen.webp"
import BaysideTwoImage from "../asset/BaysideTwo.webp"
import BaysideThreeImage from "../asset/BaysideThree.webp"
import BaysideFourImage from "../asset/BaysideFour.webp"
...
const Banner = () => {
  ...
  return (
    ...
    <div>
      ...
      <h1 className='font-[NeueBold] text-[2rem]   uppercase pr-3 lg:pr-8 border-r-[2px] border-gray-300  lg:text-[4rem]' >Bayside</h1>
      <h3 className='font-[NeueMedium] lg:text-[1.5rem] lg:mt-2 flex items-center justify-start gap-2 lg:gap-3  text-[0.8rem]' ><HiOutlineLocationMarker className='lg:text-[1.8rem] mb-1 text-[1.2rem] ' />Seawoods, Navi Mumbai</h3>
      </div>
